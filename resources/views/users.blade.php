        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    <form>
                        <div class="form-group">
                            <input type="text" class="form-control" required="required" placeholder="Desired Username" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" required="required" placeholder="Your Email" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" required="required" placeholder="Desired Password" />
                        </div>

                        <div class="form-group">
                            <a href="user-dashboard.html" class="btn btn-primary">Click To Register</a>
                        </div>
                        <strong>Note: </strong>By Singing you agree to our  <a href="#">terms & policies</a>
                    </form>
                </div>
